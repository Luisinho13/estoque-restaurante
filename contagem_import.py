...
ALIMENTOS = {
    ...
    "MOSTARDA L ' ANCIENE": _i("Mostarda", A_DEFINIR, "kg"),
    ...
    "LOMBO CANADENSE": _i("Lombo", A_DEFINIR, "kg"),
    ...
    "QUEIJO CAMEMBERE FRACIONADO": _i("Queijo camembert", A_DEFINIR, "kg"),
    "QUEIJO CHEDDAR FATIADO KG (VIGOR)": _i("Queijo cheddar", A_DEFINIR, "kg"),
    ...
    "MINI HAMBURGUE": _i("Hambúrguer", A_DEFINIR, "kg"),
    ...
    "PEITO DE FRANGO PORCIONADO - ISCAS (FRANGO GOURMET) / (CAMARA 3)": _i("Frango", A_DEFINIR, "kg"),
    "PEITO DE FRANGO PORCIONADO - KIDS": _i("Frango", 1, "kg"),
    "PEITO DE FRANGO PORCIONADO FONDUE (CAMERA - 3)": _i("Frango", 1, "kg"),
    "PEITO DE FRANGO PORCIONADO PARMEGIANA(GARDE)": _i("Frango", A_DEFINIR, "kg"),
    ...
    "AMORA PCT": _i("Amora", A_DEFINIR, "kg"),
    "FRAMBOESA PCT": _i("Framboesa", A_DEFINIR, "kg"),
    ...
    "PAO ITALIANO COMPRIDO FILÃO UND": _i("Pão", A_DEFINIR, "kg"),
    ...
    "ABOBORA CABOTIAN": _i("Abóbora", A_DEFINIR, "kg"),
    "ABOBRINHA ITALIANA KG (CX C/ 18KG)": _i("Abobrinha", 1, "kg"),
    "ACELGA": _i("Acelga", 1, "maço"),
    "ALECRIM MAÇO": _i("Alecrim", A_DEFINIR, "kg"),
    "ALFACE AMERICANA": _i("Alface", A_DEFINIR, "kg"),
    "ALFACE CRESPA": _i("Alface", A_DEFINIR, "kg"),
    "ALFACE ROXA": _i("Alface", A_DEFINIR, "kg"),
    ...
    "BROCOLIS NINJA": _i("Brócolis", A_DEFINIR, "kg"),
    ...
    "FOLHA DE LORO": _i("Louro", A_DEFINIR, "kg"),
    ...
    "MANJERICÃO MAÇO": _i("Manjericão", A_DEFINIR, "kg"),
    ...
    "SALSA CRESPA": _i("Salsinha", A_DEFINIR, "kg"),
    "SALSÃO MAÇO": _i("Salsão", A_DEFINIR, "kg"),
    "SALSINHA MAÇO": _i("Salsinha", A_DEFINIR, "kg"),
    "SALVIA": _i("Sálvia", 1, "maço"),
    "TOMATE CEREJA VERMELHO": _i("Tomate cereja", A_DEFINIR, "kg"),
    "TOMATE DEBORA": _i("Tomate", 1, "kg"),
    "TOMATE P/ MOLHO ITALIANO MADURO KG (CX C/ 20KG)": _i("Tomate", 20, "kg"),
    "TOMILHO": _i("Tomilho", A_DEFINIR, "kg"),
    ...
    "CROQUETA COSTELA": _i("Croqueta de costela", A_DEFINIR, "kg"),
    "Bolinho de Pernil": _i("Bolinho de pernil", 1, "pacote"),
    "BOLINHO DE CAMARÃO": _i("Bolinho de camarão", A_DEFINIR, "kg"),
